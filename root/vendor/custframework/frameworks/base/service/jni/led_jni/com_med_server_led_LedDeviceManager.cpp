/**
 * File: com_med_server_led_LedDeviceManager.cpp
 * Breif: Endoscope jni
 *
 * Name: 
 * Date: 
...
static const char* const kClassName =
        "com/med/server/led/LedDeviceManager";
        
static NativeLedClient* pClient = nullptr;
